...
#Importing the data 
data_CAD_inci = pd.read_csv("UKB_CAD_clinical_FD_dataset.csv")

#Defining the variables
y = data_CAD_inci["CAD_block"]
X= data_CAD_inci.drop(["IID","CAD_block"], axis=1)


#Train and test the CAD model. Testing implies using 10 fold CV and using the same partinioning across all the models 
...
for train_idx, val_idx in cv_outer.split(X, y):
    ...
    name = "CAD_models_predictions_F" + str(counter) + ".csv"
...
F0 = pd.read_csv("CAD_models_predictions_F0.csv", header = None)
F1 = pd.read_csv("CAD_models_predictions_F1.csv", header = None)
F2 = pd.read_csv("CAD_models_predictions_F2.csv", header = None)
F3 = pd.read_csv("CAD_models_predictions_F3.csv", header = None)
F4 = pd.read_csv("CAD_models_predictions_F4.csv", header = None)
F5 = pd.read_csv("CAD_models_predictions_F5.csv", header = None)
F6 = pd.read_csv("CAD_models_predictions_F6.csv", header = None)
F7 = pd.read_csv("CAD_models_predictions_F7.csv", header = None)
F8 = pd.read_csv("CAD_models_predictions_F8.csv", header = None)
F9 = pd.read_csv("CAD_models_predictions_F9.csv", header = None)
pred_results_CAD = pd.concat([F0,F1, F2,F3, F4, F5, F6, F7, F8, F9], axis=0)
pred_results_CAD.columns = ['index','True_data', 'SCORE', 'RFC_Df', 'RFC_DfPRS', 'RFC_PRS']
pred_results_CAD.to_csv("CAD_models_predictions_10FCV.csv", index=None)
